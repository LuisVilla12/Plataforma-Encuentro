...
<body class="bg-gray-100 font-sans">
    ...
    <div class="max-w-xl mx-auto mt-12 bg-white shadow-md rounded-lg px-8 py-6">
        ...
        <h1 class="text-xl text-center font-semibold text-gray-800 mb-2 mt-6">
            Registro {{ $dato->id }} del prototipo de libro
        </h1>
        ...
        <div>
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">
                    <a href="{{ asset('storage/' . $dato->url_prototipo) }}" class="flex items-center mb-2"
                        target="_blank">
                        <x-heroicon-o-document-text class="w-6 h-6" /> Prototipo
                    </a>
                </label>
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">
                    <a href="{{ asset('storage/' . $dato->url_resumen) }}" class="flex items-center mb-2"
                        target="_blank">
                        <x-heroicon-o-document-text class="w-6 h-6" /> Resumen del prototipo
                    </a>
                </label>
            </div>
