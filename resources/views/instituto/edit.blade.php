...
<body class="bg-gray-100 font-sans">
    <div class="max-w-xl mx-auto mt-12 bg-white shadow-md rounded-lg px-8 py-6">
        ...
        <h1 class="text-xl text-center font-semibold text-gray-800 mb-2 mt-6">
            Editar Registro de institutos al 3er. Encuentro de CA's
        </h1>
        ...
        <form action="{{ route('instituto.update', $instituto) }}" id="myForm" method="POST"
            ...
            <div class="mt-2">
                ...
                <input type="text" name="nombre" id="nombre" value="{{ $instituto->nombre }}" required
